# kununu Universal Frontend Architecture Demo

This demo is a showcase of @kununu's universal frontend setup. It has been generated using [create-universal-react-app](https://github.com/kununu/create-universal-react-app/), which provides encapsulated build tooling and configuration.
...
Dependencies and configuration for tooling are centralized in [create-universal-react-app](https://github.com/kununu/create-universal-react-app/).

## Old readme generated from `create-universal-react-app`

This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
This project was also created using [React Server](https://github.com/redfin/react-server/blob/5e3714e119a3b7994adfe441856e43b014e0eb4e/packages/react-server-examples/hello-world/README.md).
